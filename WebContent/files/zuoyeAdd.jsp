...
<form action="addZuoye.do"  method="post"  enctype="multipart/form-data"   name="form"   >
    <div class="MainDiv">
                                ...
                                <fieldset style="height:100%;">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%"><input name='title'   class="text" style="width:154px"  />
...
<input name='file'  type="file" class="text" style="width:154px"  />
                                         ...
                                         <tr>
                                            ...
                                            <td width="34%">  <input name='tu'  type="file" class="text" style="width:154px"  /> </td>
                                        </tr> 
