...
<form action="updateStudent.do" method="post"    name="form"   >
    <div class="MainDiv">
                            ...
                            <TD width="100%">
                                <fieldset style="height:100%;">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
                                          <input type="hidden" name="stid" value="${g.stid }" >
                                        <tr>
                                            <td nowrap align="right" width="15%">学号:</td>
                                            <td width="35%"><input name='xh' value="${g.xh }"   class="text" style="width:154px"  />
                                                <span class="red">*</span></td>
                                           <td width="16%" align="right" nowrap="nowrap">姓名</td>
                                            <td width="34%">
                                              <input name='name' value="${g.name }"  class="text" style="width:154px"  />
                                              </td>
                                        </tr>
                                        <tr>
                                            <td nowrap="nowrap" align="right">性别</td>
                                            <td><input  type="radio" name='sex'  <c:if test="${g.sex=='男'}">checked</c:if>  value="男"     />男
                                            <input    type="radio" name='sex' <c:if test="${g.sex=='女'}">checked</c:if>   value="女"     />女
                                            </td>
