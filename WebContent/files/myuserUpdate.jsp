...
<form action="updateMyuser.do" method="post"    name="form"   >
    <div class="MainDiv">
                                ...
                                <fieldset style="height:100%;">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%"><input name='name'  value="${g.name }"   class="text" style="width:154px"  />
                                            <input name='uid'  value="${g.uid  }"  type="hidden"  class="text" style="width:154px"  />
                                                <span class="red">*</span></td>
                                           <td width="16%" align="right" nowrap="nowrap">登录名</td>
                                            <td width="34%">
                                             <input name='login'  value="${g.login }"   class="text" style="width:154px"  />
                                              </td>
                                        </tr>
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td>男<input    name='sex' value="男"  type="radio" <c:if test="${g.sex=='男' }">checked</c:if>    />
                                                女<input    name='sex' value="女"  type="radio" <c:if test="${g.sex=='女' }">checked</c:if>   />
                                            </td>
                                              <td width="16%" align="right" nowrap="nowrap">是否展示电话号</td>
                                            <td width="34%">是<input    name='isbaomi' value="是"  type="radio" <c:if test="${g.isbaomi=='是' }">checked</c:if>   />
